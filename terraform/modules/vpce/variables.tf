...
variable "security_group_ids" {
  type        = list(string)
  description = "List of security group IDs that should be associated with the VPC endpoint"
  default     = null
}

variable "route_table_ids" {
  type        = list(string)
  description = "List of route table IDs that should be associated with the VPC endpoint"
  default     = null
}
